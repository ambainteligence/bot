 ...
 */
class Version20181002082830 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE back_profit CHANGE uid uid VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE back_profit CHANGE uid uid VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
