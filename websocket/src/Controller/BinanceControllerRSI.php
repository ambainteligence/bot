...
class BinanceControllerRSI extends Controller
{
  const BUY = 'buy';
  const SELL = 'sell';
...
//    $rsiLines = trader_rsi($results , 14);
//
//    $currentRSILine = array_pop($rsiLines);
//    $prevRSILine = array_pop($rsiLines);
//    $prevPrevRSILine = array_pop($rsiLines);
//    $prevPrevPrevRSILine = array_pop($rsiLines);
//
...
//
//    $this->helper->calculatorProfit($uid = 1, date('d/m/Y'), $percent = 0.03);
//
//
...
////          if ($this->checkSellRSI($prevPrevPrevRSILine, $prevPrevRSILine, $prevRSILine, $text)) {
//          if ($this->checkSellCurrent($currentRSILine, $text)) {
...
//        }
//        else {
////          if ($this->checkBuyRSI($prevPrevPrevRSILine, $prevPrevRSILine, $prevRSILine, $text)) {
//          if ($this->checkBuyCurrent($currentRSILine, $text)) {
//            // buy at here
...
//    });
    ...
    dump($this->bowhead_stoch_adx('', $data));
